...
export const foodCategories: FoodCategory[] = [
  {
    ...
    subCategories: [
      ...
      {
        name: '국수·칼국수',
        restaurants: ['베테랑 칼국수 덕진점', '할매손 칼국수', '전주 잔치국수'],
      },
    ],
  },
  {
    ...
    subCategories: [
      ...
      {
        name: '양꼬치·중화요리',
        restaurants: ['아방궁 양꼬치', '천리향', '구정문 양꼬치', '심양 양꼬치'],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    subCategories: [
      ...
      {
        name: '커리·인도',
        restaurants: ['델리 인디아', '나마스떼 전주점', '커리포트', '아그라 인도요리'],
      },
      {
        name: '태국·기타',
        restaurants: ['방콕야시장', '팟타이집 구정문', '사와디캅 전주', '타이 인 전주'],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    subCategories: [
      {
        name: '샌드위치·샐러드',
        restaurants: ['써브웨이 전북대점', '샐러디 전북대점', '에그드랍 구정문점'],
      },
      {
        name: '토스트·브런치',
        restaurants: ['이삭토스트 전북대점', '프랭크 토스트', '카페 마당 브런치'],
      },
    ],
  },
]
